<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Proses Survey<small></small></h1>
					...
					<table class="table">
						...
						<tbody>
							...
							<td>
								...
								<a href="<?= base_url() ?>home/aksisurvey/<?= $pl->id_form ?>"><button class="btn btn-primary"><i class="fas fa-broadcast-tower"></i></button></a>
