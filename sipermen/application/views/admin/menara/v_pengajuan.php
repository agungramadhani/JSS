	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb float-xl-right">
				...
				<li class="breadcrumb-item active">Pengajuan Tempat</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Pengajuan Tempat<small></small></h1>
				...
				<div id="table" class="card-body">
					<table class="table">
						...
						<tbody>
							...
							<td><?= $no ?></td>
							<td><?= $pl->id_form ?></td>
							<td><?= $pl->alamat ?> , <?= $pl->kelurahan?> , <?= $pl->kecamatan?></td>
							...
							<td>
								...
								<a href="<?= base_url() ?>home/aksipengajuan/<?= $pl->id_form ?>"><button class="btn btn-primary"><i class="fas fa-broadcast-tower"></i></button></a>
